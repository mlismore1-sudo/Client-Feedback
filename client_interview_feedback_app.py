...
selected_product_sub_type = st.selectbox(
    "Product Sub Type",
    options=PRODUCT_OPTIONS[selected_product_type],
    key=f"product_sub_type_selector_{selected_product_type}",
)
...
if submitted:
    ...
    if errors:
        ...
        row = {
            ...
            "Product Sub Type": selected_product_sub_type,
